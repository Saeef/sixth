      ...
      pgCssDesktop: function() {
        ...
        listRO: function() {
            ...
            function recommendedclasses(index) {
                ...
                // if(index !== 0) {
                //     $('#sx-res-offerselect-all div.price-section.price-section--prpd.plrec > div.price-section__left').addClass('sin');
                //     $('#sx-res-offerselect-all div.price-section.price-section--flex.pnrec > div.price-section__left').addClass('sin');
                //     $('#sx-res-offerselect-all div.price-section.price-section--flex.pnrec > div.price-section__right').addClass('des');
                //     $('#sx-res-offerselect-all div.price-section.price-section--prpd.plrec > div.price-section__right').addClass('des');
