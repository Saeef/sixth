                    ...
                    setTimeout(function(e) {
                        ...
                        console.log(ol[i]);
                            ...
                            if(ol[i].children[2].children[0].children[0].children[0].children[0].innerText == "OUR LOWEST RATE") {
                                ...
                                savi = ol[i].children[2].children[0].children[0].children[0].children[1].children[0];
                            
                                saving = ol[i].children[2].children[0].children[0].children[0].children[1].children[0].innerText;
